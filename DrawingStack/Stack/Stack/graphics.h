...
void setcolor(int color)
{
	...
	switch (color)
	{
		...
		case 0: PEN = getPen(PS_SOLID, 4, RGB(255, 0, 0)); break;
		case 1: PEN = getPen(PS_SOLID, 4, RGB(255, 128, 0)); break;
		case 2: PEN = getPen(PS_SOLID, 4, RGB(255, 255, 0)); break;
		case 3: PEN = getPen(PS_SOLID, 4, RGB(0,255 , 0)); break;
		case 4: PEN = getPen(PS_SOLID, 4, RGB(0,128, 0)); break;
		case 5: PEN = getPen(PS_SOLID, 4, RGB(0, 255, 255)); break;
		case 6: PEN = getPen(PS_SOLID, 4, RGB(0, 0, 128)); break;
		case 7: PEN = getPen(PS_SOLID, 4, RGB(0, 0, 255)); break;
		case 8: PEN = getPen(PS_SOLID, 4, RGB(255, 0, 255)); break;
		case 9: PEN = getPen(PS_SOLID,4, RGB(255, 105, 180)); break;
		case 10: PEN = getPen(PS_SOLID, 4, RGB(255, 228, 196)); break;
		case 11: PEN = getPen(PS_SOLID, 4, RGB(210, 105, 30)); break;
		case 12: PEN = getPen(PS_SOLID, 4, RGB(112, 128, 144)); break;
		case 13: PEN = getPen(PS_SOLID, 4, RGB(240, 255, 255)); break;
		case 14: PEN = getPen(PS_SOLID, 4, RGB(128, 128, 128)); break;
		case 15: PEN = getPen(PS_SOLID, 4, RGB(255, 255, 255)); break;
	}
}
