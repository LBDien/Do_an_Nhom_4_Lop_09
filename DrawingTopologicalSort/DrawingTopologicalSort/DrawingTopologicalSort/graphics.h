...
void drawText(int x, int y, const char* mess,int color) {
	...
	switch (color)
	{
	case 0: SetTextColor(device_context, RGB(255, 255, 255)); break;
	case 1: SetTextColor(device_context, RGB(0, 128, 128)); break;
...
void rectangle(int x1, int y1, int x2, int y2)
{
	...
	POS.X = (short)x2 + movx;
	POS.Y = (short)y2 + mov;
	PlotRect(hDC, getPen(PS_SOLID, 2, RGB(255, 0, 0)) , BGN, POS);
}
